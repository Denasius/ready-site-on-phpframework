    ...
    <section class="main">
        <div class="container">
            <div class="row">
                ...
                <?php 
                    $mobileCategory[$key] = $cats[$key];
                ?>
                    <div class="select-category">
                        <div class="select-block select-block-cat">
                    <?php foreach ($mobileCategory as $cat) : ?>
                            <p>Категория</p>
                            <div class="select-options">
                                <ul>
                                <?php foreach ( $cats as $catselect ) : ?>
                                    <li><a href="/catalog/<?= $catselect['id']; ?>" data-filter="<?=$catselect['filter'];?>"><?= $catselect['title']; ?></a></li>
                                <?php endforeach; ?>
                                </ul>
                            </div>
                        </div>
                        <?php if ( $cat['childs'] ) : ?>
                            <div class="select-block select-block-subcat">
                                <p>Подкатегория</p>
                                <div class="select-options">
                                        <ul>
                                        <?php foreach ( $cat['childs'] as $child ) : ?>
                                            <li><a href="/catalog/<?= $child['id']; ?>"><?= $child['title']; ?></a></li>
                                        <?php endforeach; ?>
                                        </ul>
                                    </div>
                            </div>
                        ...
                        <div class="bread-crumbs">
                            <ul>
                                ...
                                <?php foreach ( $breadcrumbs_array as $id => $title ) : ?>
                                    <li><a href="/catalog/<?=$id?>" data-id="<?= $id ?>"><?= $title ?><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        ...
                        <div class="site-catalog">
                            <div class="row site-catalog-grid">
                                <?php foreach ( $products as $product ) : ?>
                                    <div class="col-12 col-md-6 <?= $product['class']; ?>">
                                        <div class="cart-site">
