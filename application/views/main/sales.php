<section class="headerTop">
    ...
    <section class="banners">
        ...
        <div class="banner sales">
            <img src="/public/img/assets/catalog/banners/banner-top_2_c.jpg" alt="Баннер">
        </div>
                    ...
                    <div class="select-category">
                        <div class="select-block select-block-cat">
                            ...
                            <div class="select-options">
                                <ul>
                                    <li><a href="#" data-filter=".building">Домашние животные</a></li>
                                    <li><a href="#" data-filter=".building">Домашние животные</a></li>
                                    <li><a href="#" data-filter=".building">Домашние животные</a></li>
                                    <li><a href="#" data-filter=".building">Домашние животные</a></li>
                                    <li><a href="#" data-filter=".building">Домашние животные</a></li>
                    ...
                    <div class="wrapper">
                        <div class="bread-crumbs">
                            <ul>
                                ...
                                <li><a href="#" data-attr="this-page">Скидки<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
